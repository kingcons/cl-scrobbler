...
(defvar *error-codes*
  '((1 . "This error does not exist")
    ...
    (12 . "Subscription Error - The user needs to be subscribed in order to do that / Subscribers Only - This station is only available to paid last.fm customers")
    ...
    (18 . "The user has no free radio plays left. Subscription required")
