...
;;;; This queue code stolen and slightly adapted from Arnesi.
...
(defmethod initialize-instance :after ((queue queue) &key (size 20)
                                       (element-type t) &allow-other-keys)
  (assert (< 1 size) (size) "Initial size of a queue must be greater than 1.")
